...
{
    public partial class UstvariPlacnika : MetroForm
    {
        public UstvariPlacnika()
        {
            InitializeComponent();
        }
        ...
        private async void MetroButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var response = await client.PostAsync("https://equipment-rental.herokuapp.com/create_placnik", queryString);
                ...
                {
                    MessageBox.Show("Creation failed, this plačnik might already exist!");
                }
